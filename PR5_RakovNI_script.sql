...
INSERT INTO public.hall ("name") VALUES
	...
	INSERT INTO public.film ("name",description) VALUES
	 ('Фильм 1','Описание фильма 1'),
	 ('Фильм 2','Описание фильма 2'),
	 ('Фильм 3','Описание фильма 3'),
	 ('Фильм 4','Описание фильма 4'),
	 ('Фильм 5','Описание фильма 5'),
	 ('Фильм 6','Описание фильма 6'),
	 ('Фильм 7','Описание фильма 7'),
	 ('Фильм 8','Описание фильма 8'),
	 ('Фильм 9','Описание фильма 9'),
	 ('Фильм 10','Описание фильма 10');
